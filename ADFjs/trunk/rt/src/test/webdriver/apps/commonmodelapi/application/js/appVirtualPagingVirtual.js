require(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'ojs/ojcomponents', 'ojs/ojtable-model', 'ojs/ojtable', 'ojs/ojdatacollection-common', 'ojs/ojdatagrid', 'ojs/ojdatagrid-model', 'ojs/ojpagingcontrol-model', 'ojs/ojpagingcontrol-model'],
        function(oj, ko, $)
        {
