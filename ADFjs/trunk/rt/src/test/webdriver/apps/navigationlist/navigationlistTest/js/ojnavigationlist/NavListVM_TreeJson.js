...
define(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'ojs/ojradioset', 'ojs/ojtable', 'ojs/ojjsontreedatasource', 'ojs/ojnavigationlist', 'ojs/ojbutton', 'ojs/ojselectcombobox', 'ojs/ojinputtext', 'ojs/ojgauge'], function (oj, ko, $)// this callback gets executed when all required modules are loaded
{
    ...
    $.getJSON("../js/ojnavigationlist/files.json", function (data) {
        ...
        function ViewModel() {
            ...
            self.navListItemRenderer_dom = function (itemContext) {
                ...
                else var item = "<a href=\"#\" ><span class=\"oj-navigationlist-item-icon  demo-icon-font demo-library-icon\"></span>" + itemContext.data.name + "</a>";
            ...
            self.setCurrentNavListItem = function () {
                $('#navList').ojNavigationList("option", "currentItem", "work");
