...
require(['ojs/ojcore','jquery','knockout','checkboxsetVM','genericOptionsVM','bkUtils',
                 'simpleMenuVM','app'],
                       ...
                       $("#inputControls-container").load("../../common/inputControlsContainer.html",
                            function() {
                                ...
                                function() {
                                    ...
                                    masterVM.bk.disableButton("#btn_ro");
//                                    $("#checkboxset").on({'ojoptionchange': masterVM.model.valueChangeHandler});
                                });
                            });
                        });
              });
