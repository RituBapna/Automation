...
requirejs.config({
    ...
    paths: {
        ...
        'ojknockout-validation' : 'libs/oj/ojknockout-validation',
        'ojknockout-model' : 'libs/oj/ojknockout-model',
    ...
    shim: {
        ...
        'app': {
            deps: ['ojmodel', 'ojcore', 'ojknockout', 'ojknockout-validation', 'ojknockout-model']
        },
        'brand_bar': {
            deps: ['jquery']
        }
