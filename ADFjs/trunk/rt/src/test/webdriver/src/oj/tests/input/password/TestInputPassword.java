...
public class TestInputPassword extends TestInputPasswordBase {

    private static final String MYGROUP = "inputPasswordDialog";

    public TestInputPassword() {
        super("password", "input", "Jet ojInputPassword Test", "testInputPassword.html", "text-input");
    }
