...
public class TestSelectDialog extends TestSelectBase {

    private static final String MYGROUP = "selectDialog";

    public TestSelectDialog() {
        super("select", "input", "Jet ojSelect Test", "testSelectDialog.html",
              "select", "btn_opendialog");
    }
