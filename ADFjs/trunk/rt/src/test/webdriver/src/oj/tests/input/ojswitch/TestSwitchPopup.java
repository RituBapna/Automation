...
public class TestSwitchPopup extends TestSwitchBase {

    protected static final String MYGROUP = "switchPopup";

    public TestSwitchPopup() {
        super("switch", "input", "Jet ojSwitch Test", "testSwitchPopup.html",
              "switch", "btn_openpopup");
    }
