...
public class TestInputDatePopup extends TestInputDateBase {

    protected static final String MYGROUP = "inputDatePopup";

    public TestInputDatePopup() {
        super("date", "input", "Jet ojInputDate Test", "testInputDatePopup.html",
