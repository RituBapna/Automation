...
public class TestInputTimePopup extends TestInputTimeBase {

    protected static final String MYGROUP = "inputTimePopup";

    public TestInputTimePopup() {
        super("time", "input", "Jet ojInputTime Test", "testInputTimePopup.html",
