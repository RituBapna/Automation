...
public class CollectionFunctionTest extends OJetBase {
    ...
    public void testrestCollFunc() throws Exception {
        ...
        startupTest("CollectionFunctions.html",null);
	...
	public void testGetCollectionProperties() throws Exception {
				...
				waitForText(RESULTS_CONTAINER, "Comparator: Dname, fetchSize: -1");
		...
		@Test(groups = { "cma"}, dependsOnMethods = { "testGetCollectionProperties"})
			   public void testModelProperties() throws Exception {
					...
					waitForText(RESULTS_CONTAINER, "Attributes: Deptno: 10, Dname: ACCOUNTING, Loc:PORTLAND");
					...
					waitForText(RESULTS_CONTAINER, "Index of Model with Deptno 10: 9");
					waitForText(RESULTS_CONTAINER, "{\"Deptno\":10,\"Dname\":\"ACCOUNTING\",\"Loc\":\"PORTLAND\"");
...
@Test(groups = { "cma"}, dependsOnMethods = { "testModelProperties"})
	   public void deleteModelFromColl() throws Exception {
			...
			testlastIndexOf = getElement("id=testlastIndexOf");
			testlastIndexOf.click();

			waitForMilliseconds(3000L);

			String text = getElement("id=resultsFunction").getText();

			waitForText(RESULTS_CONTAINER, "Index of Model with Deptno 10: -1");
			Assert.assertTrue(text.contains("Model Found: {\"Deptno\":70,"));
		}
	   ...
	   public void testFewModelFunctions() throws Exception {
			...
			waitForText(RESULTS_CONTAINER, "{\"Deptno\":30,\"Dname\":\"SALES12\"");
			...
			getMax.click();
			waitForMilliseconds(2000L);
			waitForText(RESULTS_CONTAINER, "90");

			WebElement getMin = getElement("id=getMin");
			getMin.click();
			waitForMilliseconds(2000L);
			waitForText(RESULTS_CONTAINER, "10");

			WebElement pluckAllDeptByName = getElement("id=pluckAllDeptByName");
			pluckAllDeptByName.click();
			waitForMilliseconds(2000L);
			waitForText(RESULTS_CONTAINER,"name4534");
			waitForText(RESULTS_CONTAINER,"SALES12");
			waitForText(RESULTS_CONTAINER,"RESEARCH");
			waitForText(RESULTS_CONTAINER,"OPERATIONS");
			waitForText(RESULTS_CONTAINER,"MARKETING");
			waitForText(RESULTS_CONTAINER,"ENGINEERING");
			waitForText(RESULTS_CONTAINER,"EDUCATION");
			waitForText(RESULTS_CONTAINER,"Dept90");
			waitForText(RESULTS_CONTAINER,"DESIGN");
			waitForText(RESULTS_CONTAINER,"ACCOUNTING");
	   ...
	   public void testPushPopShiftSlice() throws Exception {
			...
			waitForMilliseconds(3000L);
			log("text: "+ getElement("id=resultsFunction").getText());
			waitForText(RESULTS_CONTAINER, "Department Sliced: 50,80,60,90,70,10,");
		}
 ...
 @Test(groups = { "cma"}, dependsOnMethods = { "testSyncMethodOptions"})
	   ...
	   public void testRestCollFuncValues() throws Exception {
		...
		public void crudDepartment() throws Exception {
				...
				try{
					...
					Assert.assertEquals("abcLocUpdated",row1Col2.getText());
						...
						log("I am here in exception");
						//deleteIcon1.click();
				}

				try{
					deleteIcon = getElement("id=delete9");
					log("deleteIcon from crud department" + deleteIcon);
					deleteIcon.click();
				}catch(Exception e){
					deleteIcon = getElement("id=delete9");
					deleteIcon.click();
		...
		public void crudEmployee() throws Exception {
				...
				WebElement deleteIcon = null;
				WebElement emprow3Col0 =  null;
				WebElement emprow3Col1 = null;
				WebElement emprow3Col2 = null;
				...
				try {
					...
					deleteIcon = getElement("id=deleteEmp9");
					deleteIcon.click();
					waitForMilliseconds(5000L);
    ...
    private void log(String log)
	{
		...
		getLogger().fine("[CollectionFunctionTest] " + log);
	}
