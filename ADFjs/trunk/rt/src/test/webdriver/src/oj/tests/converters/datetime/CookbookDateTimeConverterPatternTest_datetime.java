...
public class CookbookDateTimeConverterPatternTest_datetime extends OJetBase {
    ...
    private static final String DATE2_ID = "datetime3";

    public CookbookDateTimeConverterPatternTest_datetime() {
    ...
    public void testDateConverter() throws Exception {
        ...
        Assert.assertEquals(msg.getText().trim(), "Enter a value in the same format as this example: 'Nov 29, 1998, 3:45:31 PM'");
        ...
        actions.sendKeys(input, "7-23-15 11"); //enter the new value
        ...
        String value = input.getAttribute("value");
         ...
         Assert.assertEquals("Jul 23, 2015, 11:00:00 AM", value);
    }
    ...
    public void testInvalidMonth() throws Exception {
        ...
        Actions actions = new Actions(getWebDriver());
        actions.sendKeys(input, Keys.ESCAPE);
        actions.sendKeys(input, "Dcember 30, 00 10 pm");
        ...
        Assert.assertTrue(hasValidationErr);
        WebElement msg = getMessagingContentNodeBySubId(input, "oj-messaging-inline-message-summary", 0);
        Assert.assertEquals(msg.getText().trim(), "Value '0' is out of range for the 'month'.");
        msg = getMessagingContentNodeBySubId(input, "oj-messaging-inline-message-detail", 0);
        ...
        actions.sendKeys(input, Keys.ESCAPE);
        actions.sendKeys(input, Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), Keys.DELETE); //delete the existing value
        actions.sendKeys(input, "December 30, 00 10 pm"); //enter the new value
        actions.moveToElement(input2).click().perform(); // move focus to next input date field
        //Verify that error is removed
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
        ...
        String value = input.getAttribute("value");
         ...
         Assert.assertEquals("Dec 30, 2000, 10:00:00 PM", value);
    ...
    public void testInvalidDay() throws Exception {
        ...
        Actions actions = new Actions(getWebDriver());
        actions.sendKeys(input, Keys.ESCAPE);
        actions.sendKeys(input, "02/30/2016 9:00");
        ...
        actions.sendKeys(input, Keys.ESCAPE);
        actions.sendKeys(input, Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), Keys.DELETE); //delete the existing value
        actions.sendKeys(input, "02/29/2016 9:00"); //enter the new value
        actions.moveToElement(input2).click().perform(); // move focus to next input date field
        //Verify that error is removed
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
        ...
        String value = input.getAttribute("value");
         ...
         Assert.assertEquals("Feb 29, 2016, 9:00:00 AM", value);
    ...
    public void testInvalidHour() throws Exception {
        ...
        Actions actions = new Actions(getWebDriver());
        actions.sendKeys(input, Keys.ESCAPE);
        actions.sendKeys(input, "Feb 29, 2016 14:00");
        ...
        actions.sendKeys(input, Keys.ESCAPE);
        actions.sendKeys(input, Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), Keys.DELETE); //delete the existing value
        actions.sendKeys(input, "Feb 29, 16, 12:00 PM"); //enter the new value
        actions.moveToElement(input2).click().perform(); // move focus to next input date field
        //Verify that error is removed
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
        ...
        String value = input.getAttribute("value");
         ...
         Assert.assertEquals("Feb 29, 2016, 12:00:00 PM", value);
    ...
    public void testInvalidMinute() throws Exception {
        ...
        Actions actions = new Actions(getWebDriver());
        actions.sendKeys(input, Keys.ESCAPE);
        actions.sendKeys(input, "02/29/2016 09:61");
        ...
        actions.sendKeys(input, Keys.ESCAPE);
        actions.sendKeys(input, Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), Keys.DELETE); //delete the existing value
        actions.sendKeys(input, "02/29/2016 09:59 PM"); //enter the new value
        actions.moveToElement(input2).click().perform(); // move focus to next input date field
        //Verify that error is removed
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
        ...
        String value = input.getAttribute("value");
         ...
         Assert.assertEquals("Feb 29, 2016, 9:59:00 PM", value);
    ...
    public void testInvalidSecond() throws Exception {
        ...
        Actions actions = new Actions(getWebDriver());
        actions.sendKeys(input, Keys.ESCAPE);               
        actions.sendKeys(input, "02/29/2016 09:59:60");
        ...
        Assert.assertTrue(hasValidationErr);
        WebElement msg = getMessagingContentNodeBySubId(input, "oj-messaging-inline-message-summary", 0);
        Assert.assertEquals(msg.getText().trim(), "Value '60' is out of range for the 'second'.");
        msg = getMessagingContentNodeBySubId(input, "oj-messaging-inline-message-detail", 0);
        Assert.assertEquals(msg.getText().trim(), "Enter a value between '0' and '59'.");
        ...
        actions.sendKeys(input, Keys.ESCAPE);
        actions.sendKeys(input, Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), Keys.DELETE); //delete the existing value
        actions.sendKeys(input, "02/29/2016 09:59:59 PM"); //enter the new value
        actions.moveToElement(input2).click().perform(); // move focus to next input date field
        //Verify that error is removed
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
        ...
        String value = input.getAttribute("value");
         ...
         Assert.assertEquals("Feb 29, 2016, 9:59:59 PM", value);
    ...
    public void testLenientParsing1() throws Exception {
       ...
       String value = input.getAttribute("value");
        ...
        Assert.assertEquals("Dec 20, 2016, 12:00:00 AM", value);
    ...
    public void testLenientParsing2() throws Exception {
        ...
        Actions actions = new Actions(getWebDriver());
        actions.sendKeys(input, Keys.ESCAPE);
        actions.sendKeys(input, "2016, 30 Nov 06?:45:9 pm");
      
        actions.moveToElement(input2).click().perform(); // move focus to input date field 2
        //verify the date 
      //  String value = evalJavascript("return $('#" + DATE1_ID+"').ojInputDate('option', 'value')");
        String value = input.getAttribute("value");
        Assert.assertEquals("Nov 30, 2016, 6:45:09 PM", value);
