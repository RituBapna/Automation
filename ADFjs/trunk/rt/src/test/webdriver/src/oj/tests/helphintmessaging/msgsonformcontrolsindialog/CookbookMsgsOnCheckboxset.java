...
public class CookbookMsgsOnCheckboxset extends OJetBase {
    public CookbookMsgsOnCheckboxset() {
        ...
        openDialog();
            waitForElementVisible("id=showHiddenMessages");
        ...
        //  WebElement text = getElement("id=fatalopt");
        ...
        WebElement radioset = getElement("id=checkboxSetId");
        ...
        startupTest("demo-helpHintsMessaging-dialogFormMessages.html", null);
        verifyTitle("Incorrect page title;", "Help, Hints and Messaging - Note Window Messages on Form Controls in Dialog");
        waitForElementVisible("id=openDialogBtn");         openDialog();
            waitForElementVisible("id=showHiddenMessages");
