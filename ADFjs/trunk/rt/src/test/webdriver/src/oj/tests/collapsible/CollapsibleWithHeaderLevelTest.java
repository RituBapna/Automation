...
public class CollapsibleWithHeaderLevelTest extends OJetBase
{
  
  public CollapsibleWithHeaderLevelTest()
  {                                               
    super(new TestConfigBuilder().setContextRoot("layoutNavigation").setAppRoot("collapsibleTest").build());
  }

    @Test(groups = { "collapsible" })
  public void collapsibleWithHeaderLevelTest()throws Exception
  {
    startupTest("collapsibleWithHeaderLevelPage.html",null);
    maximizeWindow();
    String text=null;
