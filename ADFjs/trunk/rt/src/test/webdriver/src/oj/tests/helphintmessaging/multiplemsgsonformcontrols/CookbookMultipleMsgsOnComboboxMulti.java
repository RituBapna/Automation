...
public class CookbookMultipleMsgsOnComboboxMulti extends OJetBase{
    public CookbookMultipleMsgsOnComboboxMulti() {
        ...
        /*
        *  Test how combobox component respond when multiple messages of different severities are set using the messages options
        ...
        */
        ...
        //initially no msg exists on combobox
        //move focus on combobox and verify no notewindow exists

        Actions actions = new Actions(getWebDriver());
        WebElement text = getElement("{\"element\":\"#comboboxMulti\",\"subId\":\"oj-combobox-input\"}");
        ...
        Assert.assertNull(msg, "initially no message exists on combobox");
        ...
        WebElement parentElem = getParentElement(getParentElement(getParentElement(text)));
        String classes = parentElem.getAttribute("class");
        boolean hasValidationErr = classes.indexOf("oj-invalid") > -1;
        Assert.assertFalse(hasValidationErr, "oj-invalid is NOT applied to combobox");
        hasValidationErr = classes.indexOf("oj-warning") > -1;
        Assert.assertFalse(hasValidationErr, "oj-warning is NOT applied to combobox");
        ...
        //verify that oj-invalid is not applied to it
        parentElem = getParentElement(getParentElement(getParentElement(text)));
        ...
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-warning") > -1;
        Assert.assertTrue(hasValidationErr, "oj-warning is applied to combobox");
        ...
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
        Assert.assertTrue(hasValidationErr, "oj-invalid is applied to combobox");
        ...
        //unselect all msg types and verify that ucombobox has no msges
        actions.sendKeys(Keys.ESCAPE).build().perform();
        fatalBtn.click();
        errorBtn.click();
        warningBtn.click();
        ...
        actions.moveToElement(text).click().perform();
        msg = getMessagingContentNodeBySubId(text, "oj-messaging-popup-message-summary", 0);
        Assert.assertNull(msg, "no message exists on combobox");
        }
        ...
        */
        ...
        //Deselect fatal msg
        fatalBtn.click();
        //Move focus on combobox and verify that 4 msg types are displayed in order with correct icons
