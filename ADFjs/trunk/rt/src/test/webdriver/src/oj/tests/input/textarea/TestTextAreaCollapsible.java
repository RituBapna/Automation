...
public class TestTextAreaCollapsible extends TestTextAreaBase {

    private static final String MYGROUP = "textAreaCollapsible";

    public TestTextAreaCollapsible() {
        super("textarea", "input", "Jet ojTextArea Test", "testTextAreaCollapsible.html",
