...
public class TestInputDateCollapsible extends TestInputDateBase {

    private static final String MYGROUP = "inputDateCollapsible";

    public TestInputDateCollapsible() {
        super("date", "input", "Jet ojInputDate Test", "testInputDateCollapsible.html",
