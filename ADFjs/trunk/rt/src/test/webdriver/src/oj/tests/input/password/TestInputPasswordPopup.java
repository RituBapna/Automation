...
public class TestInputPasswordPopup extends TestInputPasswordBase {

    protected static final String MYGROUP = "inputPasswordPopup";

    public TestInputPasswordPopup() {
        super("password", "input", "Jet ojInputPassword Test", "testInputPasswordPopup.html",
