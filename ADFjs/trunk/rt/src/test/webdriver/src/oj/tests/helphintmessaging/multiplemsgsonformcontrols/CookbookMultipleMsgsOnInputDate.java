...
public class CookbookMultipleMsgsOnInputDate extends OJetBase {
    public CookbookMultipleMsgsOnInputDate() {
    ...
    /*
     *  Test how inputDate component respond when multiple messages of different severities are set using the messages options
    ...
    public void testAddMultipleMessages() throws Exception {
        ...
        waitForElementVisible("id=datecontrol");

        //initially no msg exists on datecontrol
        //move focus on datecontrol and verify no notewindow exists

        Actions actions = new Actions(getWebDriver());
        WebElement text = getElement("id=datecontrol");
        ...
        Assert.assertNull(msg, "initially no message exists on inputDate");
        ...
        Assert.assertFalse(hasValidationErr, "oj-invalid is NOT applied to inputDate");
        hasValidationErr = classes.indexOf("oj-warning") > -1;
        Assert.assertFalse(hasValidationErr, "oj-warning is NOT applied to inputDate");
        ...
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-warning") > -1;
        Assert.assertTrue(hasValidationErr, "oj-warning is applied to inputDate");
        ...
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
        Assert.assertTrue(hasValidationErr, "oj-invalid is applied to inputDate");
        ...
        //unselect all msg types and verify that uinputDate has no msges
        actions.sendKeys(Keys.ESCAPE).build().perform();
        fatalBtn.click();
        errorBtn.click();
        warningBtn.click();
        ...
        actions.moveToElement(text).click().perform();
        msg = getMessagingContentNodeBySubId(text, "oj-messaging-popup-message-summary", 0);
        Assert.assertNull(msg, "no message exists on inputDate");
    }
    ...
    public void testRemoveMessageTypesOneByOne() throws Exception {
        ...
        //Deselect fatal msg
        fatalBtn.click();
        //Move focus on inputDate and verify that 4 msg types are displayed in order with correct icons
