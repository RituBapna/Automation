...
public class TestComboboxPopup extends TestComboboxBase {

    protected static final String MYGROUP = "comboboxPopup";

    public TestComboboxPopup() {
        super("combobox", "input", "Jet ojCombobox Test", "testComboboxPopup.html",
              "combobox", "btn_openpopup");
    }
