...
import oj.tests.input.number.TestInputNumberBase;

public class TestInputNumberDialog extends TestInputNumberBase {

    private static final String MYGROUP = "inputNumberDialog";

    public TestInputNumberDialog() {
        super("number", "input", "Jet ojInputNumber Test", "testInputNumberDialog.html",
              "inputnumber-id", "btn_opendialog");
    }
    ...
    public void testWidget() throws Exception {
        super.testWidget(widget + " oj-component oj-form-control");
      }
