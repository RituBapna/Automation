...
public class CookbookMultipleMsgsOnTextArea extends OJetBase{
    public CookbookMultipleMsgsOnTextArea() {
    ...
    /*
     *  Test how textArea component respond when multiple messages of different severities are set using the messages options
    ...
    public void testAddMultipleMessages() throws Exception {
        ...
        waitForElementVisible("id=textareacontrol");
