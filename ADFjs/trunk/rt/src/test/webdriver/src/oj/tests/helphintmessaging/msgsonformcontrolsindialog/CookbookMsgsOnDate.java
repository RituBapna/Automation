...
public class CookbookMsgsOnDate extends OJetBase {
    ...
    public void testRequiredMsg() throws Exception {
        ...
        Assert.assertEquals(msg.getText().trim(), "custom summary: 'input date' Required",
        ...
        Assert.assertEquals(msg.getText().trim(), "custom detail: A value is required for this field",
