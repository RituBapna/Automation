...
public class TestInputNumberCollapsible extends TestInputNumberBase {

    private static final String MYGROUP = "inputNumberCollapsible";

    public TestInputNumberCollapsible() {
        super("number", "input", "Jet ojInputNumber Test", "testInputNumberCollapsible.html",
              "inputnumber-id","collapsiblePage");
