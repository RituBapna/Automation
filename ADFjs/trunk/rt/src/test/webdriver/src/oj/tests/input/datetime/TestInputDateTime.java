...
public class TestInputDateTime extends TestInputDateTimeBase {

    private static final String MYGROUP = "inputDateTimeDialog";

    public TestInputDateTime() {
        super("datetime", "input", "Jet ojInputDateTime Test", "testInputDateTime.html", "text-input");
    }
