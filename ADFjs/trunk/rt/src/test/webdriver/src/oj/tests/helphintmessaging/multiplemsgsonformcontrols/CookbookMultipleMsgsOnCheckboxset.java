...
public class CookbookMultipleMsgsOnCheckboxset extends OJetBase {
    public CookbookMultipleMsgsOnCheckboxset() {
    ...
    public void testAddMultipleMessages() throws Exception {
        ...
        waitForElementVisible("id=checkboxSetId");

        //initially no msg exists on datetimecontrol
        //move focus on datetimecontrol and verify no notewindow exists

        //WebElement text = getElement("id=fatalopt2");
         WebElement text = getElement("id=checkboxSetId");
       ...
       // this.waitForMilliseconds(3000);
        ...
        WebElement infoBtn = getButtonAtIndexFromButtonSet(buttonset, 3);
           ((JavascriptExecutor) getWebDriver()).executeScript("arguments[0].scrollIntoView(true);", infoBtn);
        Thread.sleep(500); 
