...
public class TestCheckboxset extends TestCheckboxsetBase {

    private static final String MYGROUP = "checkboxset";

    public TestCheckboxset() {
        super("checkbox", "input", "Jet ojCheckboxset Test", "testCheckboxset.html", "checkboxset");
    }
