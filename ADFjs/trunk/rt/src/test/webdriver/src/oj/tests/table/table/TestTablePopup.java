...
public class TestTablePopup extends TestTableBase {

    private static final String MYGROUP = "tablePopup";

    public TestTablePopup() {
        super("table", "table", "Jet ojTable ojPopup Test", "testTablePopup.html", "table","btn_openpopup");
    }
