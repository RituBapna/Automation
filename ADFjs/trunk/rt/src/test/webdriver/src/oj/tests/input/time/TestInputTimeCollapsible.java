...
public class TestInputTimeCollapsible extends TestInputTimeBase {

    private static final String MYGROUP = "inputTimeCollapsible";

    public TestInputTimeCollapsible() {
        super("time", "input", "Jet ojInputTime Test", "testInputTimeCollapsible.html",
