...
public class CookbookMultipleMsgsOnInputDateTime extends OJetBase{
    public CookbookMultipleMsgsOnInputDateTime() {
        ...
        /*
        *  Test how inputDateTime component respond when multiple messages of different severities are set using the messages options
        ...
        */
        ...
        WebElement text = getElement("id=datetimecontrol");
        ...
        Assert.assertNull(msg, "initially no message exists on inputDateTime");
        ...
        //Move focus on inputDateTime field
        ...
        Assert.assertFalse(hasValidationErr, "oj-invalid is NOT applied to inputDateTime");
        hasValidationErr = classes.indexOf("oj-warning") > -1;
        Assert.assertFalse(hasValidationErr, "oj-warning is NOT applied to inputDateTime");
        ...
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-warning") > -1;
        Assert.assertTrue(hasValidationErr, "oj-warning is applied to inputDateTime");
        ...
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
        Assert.assertTrue(hasValidationErr, "oj-invalid is applied to inputDateTime");
        ...
        //unselect all msg types and verify that uinputDateTime has no msges
        actions.sendKeys(Keys.ESCAPE).build().perform();
        fatalBtn.click();
        errorBtn.click();
        warningBtn.click();
        ...
        actions.moveToElement(text).click().perform();
        msg = getMessagingContentNodeBySubId(text, "oj-messaging-popup-message-summary", 0);
        Assert.assertNull(msg, "no message exists on inputDateTime");
        }
        ...
        */
        ...
        //Deselect fatal msg
        fatalBtn.click();
        //Move focus on inputDateTime and verify that 4 msg types are displayed in order with correct icons
