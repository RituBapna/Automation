...
public class TestRadioset extends TestRadiosetBase {

    private static final String MYGROUP = "radioset";

    public TestRadioset() {
        super("radio", "input", "Jet ojRadioset Test", "testRadioset.html", "radioset");
    }
