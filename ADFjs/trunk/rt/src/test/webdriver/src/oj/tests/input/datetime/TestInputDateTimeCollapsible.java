...
public class TestInputDateTimeCollapsible extends TestInputDateTimeBase {

    private static final String MYGROUP = "inputDateTimeCollapsible";

    public TestInputDateTimeCollapsible() {
        super("datetime", "input", "Jet ojInputDateTime Test", "testInputDateTimeCollapsible.html",
