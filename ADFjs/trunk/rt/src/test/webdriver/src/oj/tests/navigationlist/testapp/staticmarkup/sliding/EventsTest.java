...
public class EventsTest extends NavigationlistTestBase {
	 ...
	 * "ON : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: null; value: zoomin; optionMetadata: [object Object];}"
	 * ) > -1; boolean optionOptionChangeCurrentItemLog = eventLog.indexOf(
	 * "OPTION : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: null; value: zoomin; optionMetadata: [object Object];}"
	 * ) > -1;
	 * 
	...
	public void testEventsOnRootParentExapandByUserAction() throws Exception {
		...
		selectListItem(NAVLIST_ID, NAVLIST_ITEM_PLAYBACK);
		...
		boolean onBeforeCurrentItemLog1 = eventLog.indexOf(
				"ON : ojbeforecurrentitem: navList data { key: prev; item: [object Object]; previousKey: playback; previousItem: [object Object];}") > -1;
		boolean optionBeforeCurrentItemLog1 = eventLog.indexOf(
				"OPTION : ojbeforecurrentitem: navList data { key: prev; item: [object Object]; previousKey: playback; previousItem: [object Object];}") > -1;
		boolean onOptionChangeCurrentItemLog1 = eventLog.indexOf(
				"ON : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: playback; value: prev; optionMetadata: [object Object];}") > -1;
		boolean optionOptionChangeCurrentItemLog1 = eventLog.indexOf(
				"OPTION : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: playback; value: prev; optionMetadata: [object Object];}") > -1;
	...
	public void testEventsOnChildItemExapandByUserAction() throws Exception {
		...
		selectListItem(NAVLIST_ID, NAVLIST_ITEM_PLAY);
		waitForMilliseconds(1000);
		// Get the log Window data
		String eventLog = evalJavascript("return $('#eventlog').ojTextArea('option', 'value')");
		// Get event log
		...
		boolean onBeforeCurrentItemLog = eventLog.indexOf(
				"ON : ojbeforecurrentitem: navList data { key: play; item: [object Object]; previousKey: prev; previousItem: [object Object];}") > -1;
		boolean optionBeforeCurrentItemLog = eventLog.indexOf(
				"OPTION : ojbeforecurrentitem: navList data { key: play; item: [object Object]; previousKey: prev; previousItem: [object Object];}") > -1;
		boolean onOptionChangeCurrentItemLog = eventLog.indexOf(
				"ON : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: prev; value: play; optionMetadata: [object Object];}") > -1;
		boolean optionOptionChangeCurrentItemLog = eventLog.indexOf(
				"OPTION : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: prev; value: play; optionMetadata: [object Object];}") > -1;
		...
		boolean onBeforeCurrentItemLog1 = eventLog.indexOf(
				"ON : ojbeforecurrentitem: navList data { key: track1; item: [object Object]; previousKey: play; previousItem: [object Object];}") > -1;
		boolean optionBeforeCurrentItemLog1 = eventLog.indexOf(
				"OPTION : ojbeforecurrentitem: navList data { key: track1; item: [object Object]; previousKey: play; previousItem: [object Object];}") > -1;
		boolean onOptionChangeCurrentItemLog1 = eventLog.indexOf(
				"ON : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: play; value: track1; optionMetadata: [object Object];}") > -1;
		boolean optionOptionChangeCurrentItemLog1 = eventLog.indexOf(
				"OPTION : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: play; value: track1; optionMetadata: [object Object];}") > -1;
	...
	@Test(groups = { "navigationlist" })
	public void testEventsOnCollapseByUserActionOnPrevLink() throws Exception {
		startupTest(TEST_PAGE, null);
		verifyTitle("Incorrect page title;", TEST_PAGE_TITLE);
		...
		// Click of Previous link to collapse
		...
		boolean onBeforeCurrentItemLog = eventLog.indexOf(
				"ON : ojbeforecurrentitem: navList data { key: play; item: [object Object]; previousKey: track1; previousItem: [object Object];}") > -1;
		boolean optionBeforeCurrentItemLog = eventLog.indexOf(
				"OPTION : ojbeforecurrentitem: navList data { key: play; item: [object Object]; previousKey: track1; previousItem: [object Object];}") > -1;
		boolean onOptionChangeCurrentItemLog = eventLog.indexOf(
				"ON : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: track1; value: play; optionMetadata: [object Object];}") > -1;
		boolean optionOptionChangeCurrentItemLog = eventLog.indexOf(
				"OPTION : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: track1; value: play; optionMetadata: [object Object];}") > -1;
	...
	@Test(groups = { "navigationlist" })
	public void testEventsOnCollapseByUserActionOnHMenu() throws Exception {
		startupTest(TEST_PAGE, null);
		verifyTitle("Incorrect page title;", TEST_PAGE_TITLE);
		...
		// Click of Previous link to collapse
		navigateBackByClickingOnHierarchicalMenuItem(NAVLIST_ID, NAVLIST_HIERARCHICAL_MENU_PLAYBACK);
		waitForMilliseconds(1000);
	 ...
	 * ) > -1; boolean onOptionChangeCurrentItemLog = eventLog.indexOf(
	 * "ON : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: null; value: prev; optionMetadata: [object Object];}"
	 * ) > -1; boolean optionOptionChangeCurrentItemLog = eventLog.indexOf(
	 * "OPTION : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: null; value: prev; optionMetadata: [object Object];}"
	 * ) > -1;
	 * 
	 ...
	 * "ON : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: playback; value: prev; optionMetadata: [object Object];}"
	 * ) > -1; boolean optionOptionChangeCurrentItemLog1 = eventLog.indexOf(
	 * "OPTION : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: playback; value: prev; optionMetadata: [object Object];}"
	 * ) > -1;
	 * 
	 * 
	 * Assert.assertTrue(onBeforeCurrentItemLog,
	 ...
	 */
	/*
	 * //Will uncomment it when bug 21315947 is fixed
	 * 
	 * @Test(groups = { "navigationlist" }) public void
	...
	public void testEventsOnExpandByMethodVetoableTrue() throws Exception {
		...
		boolean onBeforeCurrItemLog = eventLog
				.indexOf("ON : ojbeforecurrentitem: navList data { key: prev; item: [object Object];}") > -1;
		boolean optionBeforeCurrItemLog = eventLog
				.indexOf("OPTION : ojbeforecurrentitem: navList data { key: prev; item: [object Object];}") > -1;

		boolean onOptionChangeCurrItemLog = eventLog.indexOf(
				"ON : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: null; value: prev; optionMetadata: [object Object];}") > -1;
		boolean optionOptionChangeCurrItemLog = eventLog.indexOf(
				"OPTION : ojoptionchange: navList data { item: [object Object]; option: currentItem; previousValue: null; value: prev; optionMetadata: [object Object];}") > -1;
		boolean onExpandLog = eventLog
				.indexOf("ON : ojexpand: navList data { item: [object Object]; key: playback;}") > -1;
		boolean optionExpandLog = eventLog
				.indexOf("OPTION : ojexpand: navList data { item: [object Object]; key: playback;}") > -1;
		...
		Assert.assertTrue(onBeforeCurrItemLog, "on method used: ojbeforecurrentitem event called with correct parameters");
		Assert.assertTrue(optionBeforeCurrItemLog, "option used: ojbeforecurrentitem event called with correct parameters");
		Assert.assertTrue(onOptionChangeCurrItemLog, "on method used: ojoptionchange event called for currentItem");
		Assert.assertTrue(optionOptionChangeCurrItemLog, "option used: ojoptionchange event called for currentItem");
