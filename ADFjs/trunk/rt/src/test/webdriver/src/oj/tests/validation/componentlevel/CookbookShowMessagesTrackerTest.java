...
public class CookbookShowMessagesTrackerTest extends OJetBase {
    public CookbookShowMessagesTrackerTest() {
    ...
    public void testDeferredOnComponentCreation() throws Exception {
        ...
        //Click on Tracker Show Messages button
        WebElement showMsgsButton = getElement("id=showMsgsBtn2");
