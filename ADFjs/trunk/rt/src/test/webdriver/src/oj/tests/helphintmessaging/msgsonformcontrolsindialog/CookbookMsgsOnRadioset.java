...
public class CookbookMsgsOnRadioset extends OJetBase {
    public CookbookMsgsOnRadioset() {
    ...
    public void testWarningMsg() throws Exception {
        ...
        warningBtn.click();
        //Move focus on inputText field
        //Verify that warning msg type is displayed
         WebElement text = getElement("id=radioSetId");
        Actions actions = new Actions(getWebDriver());
        ((JavascriptExecutor) getWebDriver()).executeScript("arguments[0].scrollIntoView(true);", text);
        Thread.sleep(500);
    ...
    public void testInfoMsg() throws Exception {
        ...
        infoBtn.click();
        //Move focus on inputText field
        //Verify that info msg type is displayed
          WebElement text = getElement("id=radioSetId");
        Actions actions = new Actions(getWebDriver());
        ((JavascriptExecutor) getWebDriver()).executeScript("arguments[0].scrollIntoView(true);", text);
        Thread.sleep(500);
