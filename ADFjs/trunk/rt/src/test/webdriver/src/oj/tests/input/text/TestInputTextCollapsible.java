...
public class TestInputTextCollapsible extends TestInputTextBase {

    private static final String MYGROUP = "inputTextCollapsible";

    public TestInputTextCollapsible() {
        super("text", "input", "Jet ojInputText Test", "testInputTextCollapsible.html",
