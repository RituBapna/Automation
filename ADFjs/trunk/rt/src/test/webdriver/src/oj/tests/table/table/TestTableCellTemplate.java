...
public class TestTableCellTemplate extends TestTableBase {

    private static final String MYGROUP = "tableCellTemplate";

    public TestTableCellTemplate() {
        super("table", "table", "Jet ojTable Custom Cell Template Test", "testTableCellTemplate.html", "table");
    }
