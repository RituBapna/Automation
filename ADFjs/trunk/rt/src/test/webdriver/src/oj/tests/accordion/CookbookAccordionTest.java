...
public class CookbookAccordionTest extends OJetBase {
	...
	public void loadPage() throws Exception {
			...
			startupTest("uiComponents-accordion-basicAccordion.html",null);
	...
	public void accordionExpandCollapseTest() throws Exception {
		...
		waitForElementVisible("id=accordionPage");
		WebElement header1 = getElement("{\"element\":\"#c1\",\"subId\":\"oj-collapsible-disclosure\"}");
		header1.click();
        
        WebElement content=  getElement("id=accordionPage");
        
        String text=content.findElement(By.id("oj-collapsible-c1-content")).getText();
        System.out.println(text);
        Assert.assertEquals("Content 1.", text);
		...
		WebElement header3 = getElement("{\"element\":\"#c3\",\"subId\":\"oj-collapsible-disclosure\"}");
		header3.click();
		try{
			Thread.sleep(1000);
		}catch(Exception e){}
	...
	public void multipleExpansionAccordionTest() throws Exception {
		...
		//Start the test and bring up the browser
		startupTest("uiComponents-accordion-multiExpandAccordion.html",null);
		...
		WebElement innerAccordion1 = getElement("{\"element\":\"#ic1\",\"subId\":\"oj-collapsible-disclosure\"}");
	...
	public void eventAccordion() throws Exception {
		...
		//Start the test and bring up the browser
		startupTest("uiComponents-accordion-events.html",null);
		verifyTitle("Incorrect page title;", "Accordion - Events");
		waitForElementVisible("id=a1");
		WebElement eventAccordionDiv = getElement("{\"element\":\"#c1\",\"subId\":\"oj-collapsible-disclosure\"}");
