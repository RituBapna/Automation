...
public class CookbookMultipleMsgsOnInputText extends OJetBase {
    public CookbookMultipleMsgsOnInputText() {
    ...
    /*
     *  Test how inputText component respond when multiple messages of different severities are set using the messages options
    ...
    public void testAddMultipleMessages() throws Exception {
        ...
        waitForElementVisible("id=inputcontrol");

        //initially no msg exists on inputcontrol
        //move focus on inputcontrol and verify no notewindow exists
        ...
        Assert.assertNull(msg, "initially no message exists on inputText");
        ...
        //unselect all msg types and verify that uinputtext has no msges
        actions.sendKeys(Keys.ESCAPE).build().perform();
        fatalBtn.click();
        errorBtn.click();
        warningBtn.click();
        ...
        actions.moveToElement(text).click().perform();
        msg = getMessagingContentNodeBySubId(text, "oj-messaging-popup-message-summary", 0);
        Assert.assertNull(msg, "no message exists on inputText");
    }
    ...
    public void testRemoveMessageTypesOneByOne() throws Exception {
        ...
        //Deselect fatal msg
        fatalBtn.click();
        //Move focus on inputText and verify that 4 msg types are displayed in order with correct icons
