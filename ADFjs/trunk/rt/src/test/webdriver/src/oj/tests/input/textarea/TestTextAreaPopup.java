...
public class TestTextAreaPopup extends TestTextAreaBase {

    protected static final String MYGROUP = "textAreaPopup";

    public TestTextAreaPopup() {
        super("textarea", "input", "Jet ojTextArea Test", "testTextAreaPopup.html",
