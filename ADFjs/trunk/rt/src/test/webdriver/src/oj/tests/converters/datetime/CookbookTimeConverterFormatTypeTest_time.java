...
public class CookbookTimeConverterFormatTypeTest_time extends OJetBase {
    ...
    private static final String DATE1_ID = "time2";
    private static final String DATE2_ID = "time1";

    public CookbookTimeConverterFormatTypeTest_time() {
