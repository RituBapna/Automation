...
public class TestComboboxDialog extends TestComboboxBase {

    private static final String MYGROUP = "comboboxDialog";

    public TestComboboxDialog() {
        super("combobox", "input", "Jet ojCombobox Test", "testComboboxDialog.html",
              "combobox", "btn_opendialog");
    }
  ...
  public void testContextMenu() throws Exception {
    try {
      ...
      Assert.fail("Bug 23230668 - shift-f10 does not invoke context menu on comboboxes when they are in dialogs", e);
    }
