...
public class CookbookTimeConverterFormatTypeTest_inputText extends OJetBase {
    ...
    private static final String DATE1_ID = "text30";
    private static final String DATE2_ID = "time1";

    public CookbookTimeConverterFormatTypeTest_inputText() {
    ...
    public void testTimeConverter() throws Exception {
        ...
        Assert.assertEquals(msg.getText().trim(), "Enter a value in the same format as this example: '3:45:31 PM'");
        ...
        input.sendKeys("7:15 pm"); //enter the new value
        ...
        String value = input.getAttribute("value");
         ...
         Assert.assertEquals("7:15:00 PM", value);
    }
    ...
    public void testInvalidHour() throws Exception {
        ...
        actions.moveToElement(input).click().perform(); // move focus to input date field
        input.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), Keys.DELETE); //delete the existing value
        input.sendKeys("12 PM"); //enter the new value
        actions.moveToElement(input2).click().perform(); // move focus to next input date field
        //Verify that error is removed
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
    ...
    public void testInvalidMinute() throws Exception {
        ...
        actions.moveToElement(input).click().perform(); // move focus to input date field
        input.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), Keys.DELETE); //delete the existing value
        input.sendKeys("9:59:5 PM"); //enter the new value
        actions.moveToElement(input2).click().perform(); // move focus to next input date field
        //Verify that error is removed
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
        ...
        String value = input.getAttribute("value");
         ...
         Assert.assertEquals("9:59:05 PM", value);
    ...
    public void testInvalidSecond() throws Exception {
        ...
        actions.moveToElement(input).click().perform(); // move focus to input date field
        input.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), Keys.DELETE); //delete the existing value
        input.sendKeys("09:59:59"); //enter the new value
        actions.moveToElement(input2).click().perform(); // move focus to next input date field
        //Verify that error is removed
        classes = parentElem.getAttribute("class");
        hasValidationErr = classes.indexOf("oj-invalid") > -1;
        ...
        String value = input.getAttribute("value");
         ...
         Assert.assertEquals("9:59:59 AM", value);
    ...
    public void testLenientParsing1() throws Exception {
       ...
       String value = input.getAttribute("value");
        ...
        Assert.assertEquals("2:04:06 AM", value);
