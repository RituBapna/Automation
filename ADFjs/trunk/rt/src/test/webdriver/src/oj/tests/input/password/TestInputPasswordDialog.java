...
import oj.tests.input.password.TestInputPasswordBase;

public class TestInputPasswordDialog extends TestInputPasswordBase {

    private static final String MYGROUP = "inputPasswordDialog";

    public TestInputPasswordDialog() {
        super("password", "input", "Jet ojInputPassword Test", "testInputPasswordDialog.html",
