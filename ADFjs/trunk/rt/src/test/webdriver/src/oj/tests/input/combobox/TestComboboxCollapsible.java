...
public class TestComboboxCollapsible extends TestComboboxBase {

    private static final String MYGROUP = "comboboxCollapsible";

    public TestComboboxCollapsible() {
        super("combobox", "input", "Jet ojCombobox Test", "testComboboxCollapsible.html",
              "combobox","collapsiblePage");
