...
public class TestRadiosetCollapsible extends TestRadiosetBase {

    private static final String MYGROUP = "radiosetCollapsible";


    public TestRadiosetCollapsible() {
        super("radio", "input", "Jet ojRadioset Test", "testRadiosetCollapsible.html",
              "radioset","collapsiblePage");
