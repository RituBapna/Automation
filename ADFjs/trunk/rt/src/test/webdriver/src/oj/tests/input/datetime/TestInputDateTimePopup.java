...
public class TestInputDateTimePopup extends TestInputDateTimeBase {

    protected static final String MYGROUP = "inputDateTimePopup";

    public TestInputDateTimePopup() {
        super("datetime", "input", "Jet ojInputDateTime Test", "testInputDateTimePopup.html",
