...
public class TestInputTextDialog extends TestInputTextBase {

    private static final String MYGROUP = "inputTextDialog";

    public TestInputTextDialog() {
        super("text", "input", "Jet ojInputText Test", "testInputTextDialog.html",
