...
public class TestSwitchCollapsible extends TestSwitchBase {

    private static final String MYGROUP = "switchCollapsible";

    public TestSwitchCollapsible() {
        super("switch", "input", "Jet ojSwitch Test", "testSwitchCollapsible.html",
              "switch","collapsiblePage");
