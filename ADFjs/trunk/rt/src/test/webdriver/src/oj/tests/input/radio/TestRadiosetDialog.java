...
public class TestRadiosetDialog extends TestRadiosetBase {

    private static final String MYGROUP = "radiosetDialog";

    public TestRadiosetDialog() {
        super("radio", "input", "Jet ojRadioset Test", "testRadiosetDialog.html",
              "radioset", "btn_opendialog");
    }
