...
import oj.tests.table.table.TestTableBase;
public class TestTablePaging extends TestTablePagingBase {

    private static final String MYGROUP = "tablePaging";

    public TestTablePaging() {
        super("paging", "table", "Jet ojPagingControl Test", "testTablePaging.html", "table","paging");
    }
