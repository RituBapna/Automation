...
public class TestCheckboxsetCollapsible extends TestCheckboxsetBase {

    private static final String MYGROUP = "checkboxsetCollapsible";

    public TestCheckboxsetCollapsible() {
        super("checkbox", "input", "Jet ojCheckboxset Test", "testCheckboxsetCollapsible.html",
              "checkboxset","collapsiblePage");
